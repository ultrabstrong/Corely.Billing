...
namespace Corely.Billing.Consumption.Validators;

internal class ConsumptionEventValidator : AbstractValidator<ConsumptionEvent>
{
    public ConsumptionEventValidator(IUsageVocabulary vocabulary)
    {
