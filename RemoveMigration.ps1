...
#   cd Corely.Billing.DataAccessMigrations.Cli
...
Write-Host ""
Write-Warning "This removes migration files only. To revert applied migrations, run 'dotnet run -- db migrate <target>' from Corely.Billing.DataAccessMigrations.Cli."
Write-Host ""
