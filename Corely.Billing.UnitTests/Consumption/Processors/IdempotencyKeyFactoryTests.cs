...
public class IdempotencyKeyFactoryTests
{
    ...
    public void Create_ReturnsDistinctKeys_ForDifferentUnits()
    {
        ...
        Assert.NotEqual(
            ...
            IdempotencyKeyFactory.Create(context, TestUsage.Extraction, TestUsage.Document, GrantA)
        );
    }
    ...
    public void Create_Throws_ForAScopeTooLongToStore()
    {
        ...
        var context = Context(new string('x', ConsumptionConstants.IDEMPOTENCY_KEY_MAX_LENGTH));
